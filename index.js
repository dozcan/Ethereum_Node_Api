...
app.post('/Identity', function (req, res) {
    ...
    var set = async () => {
        try {
            ...
            let blockchainDataName = JSON.stringify(req.body.name);
            let blockchainDataSurname = JSON.stringify(req.body.surname);
            let blockchainDataIdentity = JSON.stringify(req.body.identity);
